...
export const roles: Role[] = [
  {
    ...
    summary:
      "Leading marketing and growth for industrial electric motors across India and international markets.",
    highlights: [
      "Building and scaling dealer and distributor networks across India, with structured market entry into East Africa, West Africa, Italy and the GCC.",
      ...
      "Designed and rolled out the ACR framework (Attract, Convert, Retain) for lead generation, structured conversion and long-term retention.",
  ...
  {
    company: "UNI MO Exports (UCAL Group)",
    title: "General Manager",
    period: "Mar 2013 – Jun 2021",
    location: "Chennai, India",
    summary:
      "Eight years building export lines for one of India's established auto component groups, promoted to General Manager.",
    highlights: [
      "Developed a 500-part Euparts range for Tenneco India, expanding reach to the EU, Belarus, Sri Lanka, the UK and Italy.",
...
export const stats = [
  ...
  { value: 15, suffix: "+", label: "markets entered worldwide" },
...
export const milestones = [
  ...
  {
    year: 2005,
    product: "Tires & exports",
    title: "Into export markets",
    text: "Head of exports at MRF, then Rane. Opened Turkey, Tunisia, Indonesia and the UK. First OEM customer at TMD Germany.",
    shape: "M100,42 A58,58 0 1 1 99.9,42 Z",
  },
  {
    year: 2013,
    product: "Auto components",
    title: "General Manager, UCAL Group",
  ...
  },
  {
    ...
    text: "GM of Marketing & Growth at LEDL Motors. Dealer networks across India, market entry into Africa and the GCC, and a B2B e-commerce portal built from scratch.",
    shape:
